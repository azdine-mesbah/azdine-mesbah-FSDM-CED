    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('duree', models.IntegerField(validators=[django.core.validators.MinValueValidator(1)], verbose_name='Durée (ans)')),
                ('ville', models.CharField(max_length=255)),
                ('etablissement', models.CharField(max_length=255, verbose_name='Etablissement')),
